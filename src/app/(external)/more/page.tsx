    ...
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 md:grid-cols-2">
          <div className="space-y-6">
            ...
            <h2 className="text-3xl font-bold text-white md:text-4xl">Built for Modern Development Teams</h2>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                <div className="mb-1 text-3xl font-bold text-white">50ms</div>
      ...
      <div id="technology" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-12 space-y-4 text-center">
          <h2 className="text-3xl font-bold text-white md:text-4xl">Built on Modern Technology</h2>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  <div className="mt-2 h-2 w-2 rounded-full bg-[oklch(0.6723_0.1606_244.9955)]"></div>
                  <div>
                    <div className="font-semibold text-white">Cloud-Native Architecture</div>
                    <div className="text-sm text-gray-400">Built for scale with Kubernetes and microservices</div>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="mt-2 h-2 w-2 rounded-full bg-[oklch(0.6723_0.1606_244.9955)]"></div>
                  <div>
                    ...
                    <div className="text-sm text-gray-400">Deploy across AWS, GCP, and Azure regions</div>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="mt-2 h-2 w-2 rounded-full bg-[oklch(0.6723_0.1606_244.9955)]"></div>
                  <div>
                    ...
                    <div className="text-sm text-gray-400">Automatically adjust resources based on demand</div>
                  </div>
                </li>
              </ul>
            </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-400">All data encrypted in transit and at rest</div>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="mt-2 h-2 w-2 rounded-full bg-[oklch(0.6723_0.1606_244.9955)]"></div>
                  <div>
                    ...
                    <div className="text-sm text-gray-400">Certified for enterprise security standards</div>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="mt-2 h-2 w-2 rounded-full bg-[oklch(0.6723_0.1606_244.9955)]"></div>
                  <div>
                    ...
                    <div className="text-sm text-gray-400">Built-in protection against attacks</div>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <div id="testimonials" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-12 space-y-4 text-center">
          <h2 className="text-3xl font-bold text-white md:text-4xl">Loved by Developers</h2>
          <p className="mx-auto max-w-2xl text-lg text-gray-400">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-400">Lead Developer, StartupXYZ</div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-400">Engineering Manager, Enterprise Inc</div>
              </div>
            </div>
          </div>
        </div>
