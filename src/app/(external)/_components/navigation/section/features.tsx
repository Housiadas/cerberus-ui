import { Code, Database, Globe, Rocket, Target, Users } from "lucide-react";

export function FeaturesSection() {
  return (
    <div id="features" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mb-12 space-y-4 text-center">
        <h2 className="font-bold text-3xl text-white md:text-4xl">Powerful Features</h2>
      ...
      <div className="grid gap-8 md:grid-cols-3">
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all duration-300 hover:bg-white/10">
          ...
          <h3 className="mb-3 font-semibold text-white text-xl">Team Collaboration</h3>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all duration-300 hover:bg-white/10">
          ...
          <h3 className="mb-3 font-semibold text-white text-xl">Data Management</h3>
          <p className="text-gray-400">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all duration-300 hover:bg-white/10">
          ...
          <h3 className="mb-3 font-semibold text-white text-xl">Global CDN</h3>
          <p className="text-gray-400">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all duration-300 hover:bg-white/10">
          ...
          <h3 className="mb-3 font-semibold text-white text-xl">Instant Deployment</h3>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all duration-300 hover:bg-white/10">
          ...
          <h3 className="mb-3 font-semibold text-white text-xl">Performance Monitoring</h3>
          <p className="text-gray-400">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all duration-300 hover:bg-white/10">
          ...
          <h3 className="mb-3 font-semibold text-white text-xl">Developer Tools</h3>
